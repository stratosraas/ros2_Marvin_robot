...
/********************************************
 *  编码器引脚定义（500线 GMR 编码器）
 *  注意：GMR 编码器自带上拉，因此 ESP32 
 *        需设置为 INPUT，而不是 INPUT_PULLUP
 ********************************************/
...
/********************************************
 *  编码器参数（基于ESP32 PCNT的2倍频特性）已经确定的  （不能进行软件计数！电机的2倍频只支持PCNT计数！）
 ********************************************/
